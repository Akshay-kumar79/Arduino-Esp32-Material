  ...
  void loop() {
    ...
    if(central){
      ...
      while(central.connected()){
        ...
        accelerometerStr.concat(myIMU.readFloatAccelX());
        accelerometerStr.concat(", ");
        accelerometerStr.concat(myIMU.readFloatAccelY());
        accelerometerStr.concat(", ");
        accelerometerStr.concat(myIMU.readFloatAccelZ());
        // accelerometerStr.concat("\n");
        Serial.println(accelerometerStr);
        characteristic.writeValue(accelerometerStr);     
        // printBLE(accelerometerStr);
